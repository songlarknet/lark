...
object Coffee:
  ...
  object Types:
    ...
    object Coin:
      ...
      def valid(i: Stream[Coin])(using builder: Node.Builder, location: lark.meta.macros.Location): Stream[Bool] =
    ...
    object Drink:
      ...
      def valid(i: Stream[Drink])(using builder: Node.Builder, location: lark.meta.macros.Location): Stream[Bool] =
    ...
    object Button:
      ...
      def valid(i: Stream[Button])(using builder: Node.Builder, location: lark.meta.macros.Location): Stream[Bool] =
