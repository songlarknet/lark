 ...
 * macro. The lack.meta.source.Node interface wraps this with a friendlier
...
class Base(invocation: Invocation):
  ...
  */
  ...
  def declare[T: SortRepr](name: String, mode: core.node.Variable.Mode)(using loc: lack.meta.macros.Location): Lhs[T] =
  ...
  def bindProperty(syntax: core.Prop.Syntax, name: String)(prop: Stream[Stream.Bool])(using loc: lack.meta.macros.Location) =
