...
import lack.meta.base.collection.{Graph, MultiMap}

import scala.collection.immutable
import lack.meta.core.node.Node.Binding.Equation
import lack.meta.core.node.Node.Binding.Subnode
import lack.meta.core.node.Node.Binding.Merge
import lack.meta.core.node.Node.Binding.Reset
...
object Slice:
  ...
  def sliceNode(n: Node, only: names.immutable.ComponentSet): Node =
    ...
    val props    = n.props.filter { p =>
      ...
      lack.meta.core.term.Compound.take.vars(p.term).forall { v =>
